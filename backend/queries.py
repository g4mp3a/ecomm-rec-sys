...
def get_user_vector_and_clicks(user_id, client):
    ...
    liked_items = results["likedItem"]

    label_names = []
    if liked_items is not None:
        label_names = ["images/"+likedItem["labelName"]+".jpg" for likedItem in liked_items]

    return user_vector, label_names
